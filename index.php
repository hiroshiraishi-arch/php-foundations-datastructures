...
<head>
<meta charset="utf-8" />
<title>Digital Library Organizer - Monochrome Edition</title>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .logo-box {
    ...
    background: linear-gradient(135deg, var(--mono-500), var(--mono-700));
  }
  ...
  .section:hover { border-color: #444; }

  .hint { color: #888; font-weight: 600; }
